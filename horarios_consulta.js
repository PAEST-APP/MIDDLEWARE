...
const infoProfe = {
    "codi_persona": 1563,
    "consultes": [
        "Dimecres 16:00-18:00",
        "Divendres 16:00-18:00",
        "Dilluns 16:00-18:00"
    ],
    "despatx": "D6-212",
    "email": "guerrero@ac.upc.edu",
    "nom_prof": "MANEL GUERRERO ZAPATA"
}
...
for (let k = 0; k < diaConsultas.length / 3; k++) {
 ...
 weekDay = diaConsultas[k*3]; //dia de la semana
    ...
    date.setHours(diaConsultas[k*3+1], 0, 0);
    //console.log(date);

    dateEnd.setDate(dateEnd.getDate() + distance); // horari de fi de la consulta
    dateEnd.setHours(diaConsultas[k*3+2], 0, 0);
    //console.log(dateEnd);
...
console.log(horaris2.sort((a,b) => (a.getTime() - b.getTime()))) ;
